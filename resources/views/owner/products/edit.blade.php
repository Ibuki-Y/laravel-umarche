            ...
            <div class="-m-2">
              ...
              <div class="p-2 w-1/2 mx-auto">
                <div class="relative">
                  ...
                  <textarea required id="information" name="information" rows="10"
              ...
              <div class="p-2 w-1/2 mx-auto">
                <div class="relative">
                  ...
                  <input required type="number" id="price" name="price" value="{{ $product->price }}"
                    class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                </div>
              </div>
              <div class="p-2 w-1/2 mx-auto">
              ...
              <div class="p-2 w-1/2 mx-auto">
                <div class="relative">
                  ...
                  <input required type="hidden" id="current_quantity" name="current_quantity" value="{{ $quantity }}">
              ...
              <div class="p-2 w-1/2 mx-auto">
                <div class="relative flex justify-around">
                  <div>
                    <input class="mr-2" type="radio" name="type" value="{{ \Constant::PRODUCT_LIST['add'] }}" checked>+
                  </div>
                  <div>
                    <input class="mr-2" type="radio" name="type" value="{{ \Constant::PRODUCT_LIST['reduce'] }}">-
                  </div>
                </div>
              </div>
              <div class="p-2 w-1/2 mx-auto">
                <div class="relative">
                  ...
                  <input required type="number" id="quantity" name="quantity" value="0"
                    class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                  <span class="text-sm">0〜99</span>
                </div>
              </div>
              <div class="p-2 w-1/2 mx-auto">
                <div class="relative">
              ...
              <div class="p-2 w-1/2 mx-auto">
                <div class="relative flex justify-around">
                  <div>
                    <input class="mr-2" type="radio" name="is_selling" value="1" @if ($product->is_selling === 1) checked @endif>販売中
                  </div>
                  <div>
              ...
              <div class="p-2 w-full flex justify-around mt-4">
                <button type="button" onclick="location.href='{{ route('owner.products.index') }}'"
                  class="text-black bg-gray-200 border-0 py-2 px-8 focus:outline-none hover:bg-gray-300 rounded text-lg">戻る</button>
